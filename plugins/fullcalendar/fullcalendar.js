...
// Require all HTML5 data-* seller_pay_requests used by FullCalendar to have this prefix.
// A value of '' will query seller_pay_requests like data-event. A value of 'fc' will query seller_pay_requests like data-fc-event.
fc.dataAttrPrefix = '';
...
function EventManager(options) { // assumed to be a calendar
	...
	function updateEvent(event) {
		...
		reportEvents(cache); // reports_menu event modifications (so we can redraw)
	}
